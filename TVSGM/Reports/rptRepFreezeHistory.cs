...
namespace Reports
{
    public partial class rptRepFreezeHistory : DataDynamics.ActiveReports.ActiveReport3
    {
        ...
        public rptRepFreezeHistory()
        {
            InitializeComponent();
            this.label3.Text = "BÁO CÁO LỊCH SỬ ĐÓNG BĂNG THẺ THÀNH VIÊN";
