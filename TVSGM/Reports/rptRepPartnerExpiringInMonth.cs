...
namespace Reports
{
    public partial class rptRepPartnerExpiringInMonth : DataDynamics.ActiveReports.ActiveReport3
    {
        ...
        public rptRepPartnerExpiringInMonth()
        {
            InitializeComponent();
            this.label3.Text = "BÁO CÁO THÀNH VIÊN SẮP HẾT HẠN TRONG THÁNG";
