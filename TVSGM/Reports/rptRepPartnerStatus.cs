...
namespace Reports
{
    public partial class rptRepPartnerStatus : DataDynamics.ActiveReports.ActiveReport3
    {
        ...
        public rptRepPartnerStatus()
        {
            InitializeComponent();
            this.label3.Text ="BÁO CÁO TRẠNG THÁI KHÁCH HÀNG";
