...
namespace Reports
{
    public partial class rptRepSynInOutPartner : DataDynamics.ActiveReports.ActiveReport3
    {
        ...
        public rptRepSynInOutPartner()
        {
            InitializeComponent();
            this.label3.Text = "BÁO CÁO TỔNG HỢP LƯỢT VÀO RA CỦA KHÁCH HÀNG";
